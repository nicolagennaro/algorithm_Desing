...
struct Partition{
  size_t k1;
  size_t k2;
  Partition(size_t n1, size_t n2): k1{n1}, k2{n2} {}
  Partition(): k1{1}, k2{2} {}
...
template<typename T>
void Insertion_Sort(T* A, size_t begin, size_t end);

template<typename T>
T Select_Pivot(T* A, size_t begin, size_t end);

template<typename T>
Partition Select_Partition(T* A, size_t begin, size_t end, T pivot);

template<typename T>
T Select(T* A, size_t j, size_t begin, size_t end);
